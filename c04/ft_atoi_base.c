...
*}*/
/*call it:
* gcc -Wall -Wextra -Werror ft_atoi_base.c && ./a.out "1234ab567" "0123456789ab" 
* gcc -Wall -Wextra -Werror ft_atoi_base.c && ./a.out "-1234ab567" "0123456789ab"
* gcc -Wall -Wextra -Werror ft_atoi_base.c && ./a.out "*^*" ")(*&^%$#@"  
* gcc -Wall -Wextra -Werror ft_atoi_base.c && ./a.out "-*^*" ")(*&^%$#@"  
* gcc -Wall -Wextra -Werror ft_atoi_base.c && ./a.out "80" "0123456789ABCDEF"*/
