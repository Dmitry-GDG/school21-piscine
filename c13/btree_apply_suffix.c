...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/09 19:33:53 by dmitry            #+#    #+#             */
/*   Updated: 2021/08/09 19:33:56 by dmitry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*	btree_apply_suffix(node, (void *)&ft_putstr);
*	free (node);
*	return (0);
*}*/
/* call it:
*gcc -Wall -Wextra -Werror btree_apply_suffix.c btree_create_node.c && ./a.out */